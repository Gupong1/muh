...
const String baseUrl = 'http://jeffantihama.rxpedia.biz.id:11647';
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            if (showContact) ...[
              _GradBtn(
                ...
                onTap: () async {
                  Navigator.pop(ctx);
                  await launchUrl(Uri.parse('https://t.me/KokLuYatim'),
  ...
  Widget _buildFooter() {
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        GestureDetector(
          onTap: () => launchUrl(
              Uri.parse('https://t.me/KokLuYatim'),
              mode: LaunchMode.externalApplication),
          child: ShaderMask(
